...
document.addEventListener("mousemove",function(event){
    let x=moveare.style.left=event.clientX+"px";
    let y=moveare.style.left=event.clientY+"px";
